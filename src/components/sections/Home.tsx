  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative">
        <RevealOnScroll><div className="text-center z-10 px-4">
            <h1 className="text-5xl md:text-4xl font-bold mb-6 bg-gradient-to-r
            ...
            <div className="flex justify-center space-x-4">
                <a href="#projects"
                className="bg-blue-800/50 text-white py-3 px-6 rounded-full font-medium transition relative overflow-hidden 
